...
import { Upload, Search, Download, Eye, Trash2, FileText, ImageIcon, File } from "lucide-react"
            ...
            <Card key={file.id}>
              ...
              <CardContent>
                <div className="flex gap-2">
                  <Button variant="outline" size="sm" onClick={() => handlePreview(file.id)}>
                    <Eye className="h-4 w-4 mr-1" />
                    Preview
                  </Button>
                  <Button variant="outline" size="sm" onClick={() => handleDownload(file.id, file.filename)}>
